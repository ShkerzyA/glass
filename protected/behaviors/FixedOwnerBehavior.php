...
class FixedOwnerBehavior extends CActiveRecordBehavior{
    ...
    public $own=array('EquipmentLog'=>'subject','Docs'=>'creator','Catalogs'=>'owner','Tasks'=>'creator','MedicalEquipment'=>'creator','Messages'=>'creator','TasksActions'=>'creator','Events'=>'creator','Eventsoper'=>'creator','EventsActions'=>'creator');
