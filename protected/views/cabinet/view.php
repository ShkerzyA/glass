...
$this->menu=array(
	...
	array('label'=>'Местные Задачи', 'url'=>'#','visible'=>(Yii::app()->user->checkAccess('inGroup',array('group'=>array('it')))),'linkOptions'=>array('class'=>'done','onclick'=>'sameTasks('.$model->id.',"cab")')),
