  ...
  <?php echo $form->labelEx($model,'timestamp_end'); ?>
   ...
   'htmlOptions' => array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'direction',array('size'=>60,'maxlength'=>250)); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'called_number'); ?>
		<?php echo $form->textField($model,'called_number',array('size'=>14,'maxlength'=>14)); ?>
	</div>
