...
$this->menu['all_menu']=array(
	...
	array('title'=>'Персонал','items'=>array(
		...
		array('label'=>'Кадры', 'url'=>array('/personnel/admin'),'items'=>array(
			...
			array('label'=>'Кадры. Отпуск', 'url'=>array('/Zempleav/admin')),
			array('label'=>'Всех в открытый огонь', 'url'=>array('/personnel/allInOpenFire')),
			array('label'=>'Пользователи Quickq', 'url'=>array('/personnel/policInQuickq')),
	...
	array('title'=>'Оборудование','items'=>array(
		array('label'=>'Инструменты админа', 'url'=>array('/equipment/adminMenu')), 
	...
	array('title'=>'Знания','items'=>array(
		...
		array('label'=>'Альтависта', 'url'=>array('/projects/altavista'),'linkOptions'=>array('target'=>'_blank')), 
	)),
