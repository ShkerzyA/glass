...
<tr>
	...
	<td><?php if(!empty($data->workplaces)){ echo '<a href="/glass/cabinet/'.CHtml::encode($data->workplaces->idCabinet->id).'">'.CHtml::encode($data->workplaces->idCabinet->cname).' №'.CHtml::encode($data->workplaces->idCabinet->num).'</a>'; }?></td>
