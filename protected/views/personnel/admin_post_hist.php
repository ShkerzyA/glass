...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		array(
			'class'=>'CButtonColumn',
			'viewButtonUrl'=>'Yii::app()->controller->createUrl("personnelPostsHistory/view",array("id"=>$data->id))',
    		'updateButtonUrl'=>'Yii::app()->controller->createUrl("personnelPostsHistory/update",array("id"=>$data->id))',
    		'deleteButtonUrl'=>'Yii::app()->controller->createUrl("personnelPostsHistory/delete",array("id"=>$data->id))',
